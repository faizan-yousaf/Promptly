  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 group">
      ...
      <div className="text-center mb-6">
        <div className="w-32 h-32 mx-auto mb-4 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
          {avatar ? (
            <img
              src={avatar}
              alt={name}
        ...
        <h4 className="text-xl font-semibold mb-2 text-white">{name}</h4>
        <p className="text-cyan-400 mb-3 font-medium">{role}</p>
