      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6 max-w-md">
              The next-generation AI prompt generator that helps you create professional, 
              effective prompts with advanced reasoning and multilingual support.
            </p>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/40 text-sm">
            © {currentYear} Promptly. All rights reserved.
          </p>
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            <span className="text-white/40 text-sm">Made with ❤️ for the AI community</span>
          </div>
        </div>
      </div>
    </footer>
